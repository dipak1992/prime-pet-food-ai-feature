      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: 620, height: '100%', paddingLeft: 80, paddingRight: 60, position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 44 }}>
            {PILLS.map((label) => (
              <div key={label} style={{ display: 'flex', background: 'rgba(16,185,129,0.18)', border: '1px solid rgba(16,185,129,0.35)', borderRadius: 100, paddingTop: 8, paddingBottom: 8, paddingLeft: 16, paddingRight: 16, fontSize: 15, color: '#A7F3D0', fontWeight: 500 }}>
                {label}
              </div>
            ))}
          </div>
